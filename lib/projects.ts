...
export const projects: Project[] = [
  {
    ...
    icon: '🎯',
    color: '#00ff88',
    github: 'https://github.com/rousanraahat/apex-lead-gen',
    featured: true,
  },
  {
    ...
    icon: '🔒',
    color: '#8b5cf6',
    github: 'https://github.com/rousanraahat/sentinel-private-ai',
  ...
  },
  {
    ...
    icon: '🎙️',
    color: '#f59e0b',
    github: 'https://github.com/rousanraahat/echo-voice-support',
    featured: true,
  },
  {
    id: 'nova-dashboard',
    ...
    icon: '📊',
    color: '#3b82f6',
    github: 'https://github.com/rousanraahat/nova-dashboard',
  ...
  },
  {
    ...
    icon: '✨',
    color: '#d4af37',
    github: 'https://github.com/rousanraahat/horizon-stories',
  ...
  },
  {
    ...
    icon: '🌍',
    color: '#06b6d4',
    github: 'https://github.com/rousanraahat/stellar-3d',
  ...
  },
  {
    ...
    icon: '👨‍💻',
    color: '#ec4899',
    github: 'https://github.com/rousanraahat/portfolio',
    featured: false,
  },
]
