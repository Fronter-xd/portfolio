...
function ProjectCard({ project, index }: { project: typeof projects[0], index: number }) {
  return (
    <motion.a
      ...
      viewport={{ once: true }}
      className="group block relative bg-[#111] rounded-xl p-6 border border-[#222] hover:border-[#00ff88]/50 transition-all duration-300 cursor-pointer"
    >
      <div 
      ...
      <h3 className="text-xl font-bold mb-2 text-white group-hover:text-[#00ff88] transition-colors flex items-center gap-2">
        {project.name}
      ...
      <div className="flex items-center gap-4">
        <span className="flex items-center gap-2 text-sm text-gray-400 group-hover:text-[#00ff88] transition-colors">
        ...
        {project.demo && (
          <span className="flex items-center gap-2 text-sm text-gray-400 group-hover:text-[#06b6d4] transition-colors">
    ...
    <main className="min-h-screen cyber-grid">
      <div className="container mx-auto px-6 py-12">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-6 py-3 bg-[#242424] text-white font-semibold rounded-lg hover:bg-[#333] transition-colors border border-[#333]"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
              </svg>
        ...
        <section id="projects">
          ...
          >
            ...
            <p className="text-gray-400 max-w-xl mx-auto">
              Click any project to view the source code on GitHub
            </p>
          </motion.div>
        ...
        <motion.section
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-r from-[#00ff88]/10 to-[#8b5cf6]/10 rounded-2xl p-8 mb-16 border border-[#00ff88]/20"
        >
          <h2 className="text-2xl font-bold text-white mb-4 text-center">Ready to Start?</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-8 py-4 border border-white/20 text-white font-semibold rounded-lg hover:bg-white/5 transition-colors text-lg"
            >
